    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=50, unique=True, validators=[django.core.validators.MinLengthValidator(3)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.TimeField(auto_now=True)),
                ('slug', models.SlugField(blank=True, editable=False, null=True, unique=True)),
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='forum.forumsubcategories')),
            ],
        ),
    ]
