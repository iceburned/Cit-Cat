    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True,
                                              validators=[django.core.validators.MinLengthValidator(2),
                                                          django.core.validators.RegexValidator('^[a-zA-z0-9_-]+$',
                                                                                                message='Ensure this value contains only letters, numbers, underscore and dashes.')])),
                ...
                ('gender',
                 models.CharField(choices=[('male', 'Male'), ('female', 'Female'), ('donotshow', "DO no't show")],
                                  max_length=9)),
                ...
                ('avatar_pic',
                 models.ImageField(blank=True, default='/media/avatars_icon.png', null=True, upload_to='')),
